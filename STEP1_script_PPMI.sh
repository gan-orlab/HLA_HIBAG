...
awk '{print 0" "$1"_"$2" "$6}' ~/runs/eyu8/QC_PPMI/*/data_here/FILTERED.fam > txt_data/pheno/$FILE.pheno
awk '{print 0" "$1"_"$2" "$5}' ~/runs/eyu8/QC_PPMI/*/data_here/FILTERED.fam > txt_data/sex/$FILE.sex
