...
echo "PROCESS      ukbb/HLA-${allel}_ukbb_Proxy_aa.txt" >> meta.script
...
mv METAL-HLA-${allel}1_aa.tbl METAL-HLA-${allel}_aa.tbl

mv METAL-HLA-${allel}1_aa.tbl.info METAL-HLA-${allel}_aa.tbl.info
